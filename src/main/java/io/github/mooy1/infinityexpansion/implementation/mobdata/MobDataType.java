...
enum MobDataType {
    ...
    ZOMBIE("僵尸", 60, 1, 2, new ItemStack[] {
    ...
    SLIME("史莱姆", 90, 1, 2, new ItemStack[] {
    ...
    SKELLY("骷髅", 90, 1, 2, new ItemStack[] {
    ...
    WITHER_SKELLY("凋零骷髅", 150, 3, 2, new ItemStack[] {
    ...
    ENDERMEN("末影人", 240, 5, 2, new ItemStack[] {
    ...
    GUARDIAN("守卫者", 240, 2, 2, new ItemStack[] {
    ...
    CHICKEN("鸡", 60, 1, 1, new ItemStack[] {
    ...
    IRON("铁傀儡", 180, 1, 2, new ItemStack[] {
    ...
    BLAZE("烈焰人", 150, 5, 2, new ItemStack[] {
    ...
    WITHER("凋零", 6000, 60, 3, new ItemStack[] {
    ...
    DRAGON("末影龙", 9000, 150, 3, new ItemStack[] {
