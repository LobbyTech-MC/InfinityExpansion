...
public final class GearTransformer extends AbstractEnergyCrafter implements RecipeDisplayItem {
    ...
    protected void setupMenu(@Nonnull BlockMenuPreset blockMenuPreset) {
        ...
        for (int i : MenuPreset.INPUT_BORDER) {
            blockMenuPreset.addItem(i, new CustomItem(Material.BLUE_STAINED_GLASS_PANE, "&9工具槽"), ChestMenuUtils.getEmptyClickHandler());
        }
        for (int i : MenuPreset.OUTPUT_BORDER) {
            blockMenuPreset.addItem(i, new CustomItem(Material.BLUE_STAINED_GLASS_PANE, "&9材料槽"), ChestMenuUtils.getEmptyClickHandler());
        }
